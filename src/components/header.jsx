...
export const Header = () => {
    ...
    return (
        <>
            <header className="u-clearfix u-header u-sticky u-sticky-08cb u-header" id="sec-0ba6" style={{ margin: 0, justifyContent: 'center'}}>
                            ...
                            <div className="u-nav-container-collapse">
                                <div className="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
                                    <div className="u-inner-container-layout u-sidenav-overflow">
                                        ...
                                        <ul className="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2"><li className="u-nav-item"><a className="u-button-style u-nav-link" href="./">Главная</a>
